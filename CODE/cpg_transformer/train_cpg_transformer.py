...
dm_parse.add_argument('--val_keys', type=str, nargs='+', default=['chr1','chr3','chr6','chr7','chr9'],
                      help='Names/keys of validation chromosomes.')
dm_parse.add_argument('--test_keys', type=str, nargs='+', default=['chr2','chr4','chr5','chr8','chr10','chr12'], 
...
log_parse.add_argument('--checkpoint_name', type=str, default='cpgtransformer.ckpt',
                       help='Name of the checkpoint file to save the model.')
...
with open('time_a.txt', 'w') as file:
    file.write(f"train_time：{execution_time} s\n")
    
trainer.save_checkpoint(args.checkpoint_name)
