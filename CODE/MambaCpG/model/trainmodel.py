...
from datamodules2 import MambaCpGDataModule
...
parser.add_argument('--csv_dir', type=str, default='./validation_results', 
                    help='Directory to save the validation metrics CSV file.')
...
# Pass the filename of y and the CSV storage path to the model
model = MambaCpG(
    ncell, 
    dim=args.dim, 
    nmamba=args.nmamba, 
