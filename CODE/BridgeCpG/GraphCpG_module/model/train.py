...
dm_parse.add_argument('--dataset_path', type=str, default="datamk/",
                      help='Datapath of datasets')
dm_parse.add_argument('--dataset', type=str, default="mk",
...
dm_parse.add_argument('--val_keys', type=str, nargs='+', default=['chr10','chr11'],
...
dm_parse.add_argument('--mask_file_path', type=str, default='MK_mask_process.ckpt',
                      help='Number of worker threads to use in data loading. Increase if you experience a CPU bottleneck.')
...
model_parse.add_argument('--maxepochs', type=float, default=20,#default=10 for HCC\MBL\Hemato or default=1 for Luo_Mouse\Luo_Homo
...
if __name__ == '__main__':
    ...
    datamodule = CpGGraphDataModule(y, segment_size=args.segment_size,
                                ...
                                cell_nums=False, mask_file_path=args.mask_file_path)
