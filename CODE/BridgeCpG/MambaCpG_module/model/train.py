...
from datamodules_pt_f import MambaCpGDataModule
...
parser.add_argument('--npz_dir', type=str, default='./val_npz_results', 
                    help='Directory to save validation y_pred/y_true npz files.')

parser.add_argument('--fixed_mask_path', type=str, default='/home/methyeval/data/lianght/2i_batch/cpgtransformer/validation_results_col2/fixed_masks.pt', 
                    help='Directory to save the masked sites .pt file.')
...
model_parse.add_argument('--total_epochs', type=int, default=2,
                         help='Cosine decay period (for learning rate scheduler).')
...
log_parse.add_argument('--log_folder', type=str, default='logfolder',
                       help='Folder where the tensorboard logs will be saved. Will additionally contain saved model checkpoints.')
log_parse.add_argument('--experiment_name', type=str, default='experiment',
                       help='Name of the run within the log folder.')
log_parse.add_argument('--earlystop', type=boolean, default=False,
...
datamodule = MambaCpGDataModule(
    ...
    masked_replace_percentage=args.masked_replace_percentage,
